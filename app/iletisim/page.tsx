...
import { Phone, Mail, Clock, MessageCircle, MapPin, Navigation } from 'lucide-react';
                        ...
                        <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
                            <div className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+905332081400" className="text-lg font-black text-gray-900 block leading-none">0533 208 14 00</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+902163922259" className="text-lg font-black text-gray-900 block leading-none">0216 392 22 59</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4 p-5 bg-charcoal-900 rounded-2xl shadow-lg overflow-hidden relative group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <a href="https://wa.me/905332081400" target="_blank" rel="noopener noreferrer" className="text-lg font-black text-white block leading-none">0533 208 14 00</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-4 space-y-3">
                            <div className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-[9px] font-black text-gray-900 uppercase tracking-widest">ATÖLYE ADRESİ</h3>
                                </div>
                                ...
                                <div className="flex gap-2">
                                    <a href="https://maps.google.com/maps?q=Beta%20%C3%B6zel%20servis" className="flex-grow flex items-center justify-center gap-2 py-2 bg-charcoal-900 text-white font-bold rounded-lg text-[8px] uppercase tracking-widest hover:bg-black transition-all">
                                        YOL TARİFİ
                                    </a>
                                    <a href="mailto:betaozelservis@gmail.com" className="flex-grow flex items-center justify-center gap-2 py-2 bg-gray-50 text-gray-900 font-bold rounded-lg text-[8px] uppercase tracking-widest hover:bg-gray-100 transition-all">
                                        E-POSTA
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-[9px] font-black text-gray-900 uppercase tracking-widest">MESAİ SAATLERİ</h3>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <div className="flex justify-between items-center text-[10px] font-bold">
                                        <span className="text-red-500 uppercase tracking-widest">Pazar</span>
